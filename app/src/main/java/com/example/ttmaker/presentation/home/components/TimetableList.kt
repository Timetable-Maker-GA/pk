...
fun TimetableList(
    ...
    val vm: TimetableListViewModel = viewModel(factory = TimetableListViewModelFactory(app.schoolRepository))
    Column(
        ...
        Text(
            text = "Manual Editing comming soon..", style = MaterialTheme.typography.bodyMedium,
