...
@Composable
fun TextFileInput(    navController: NavHostController
) {
    // Get the application context
    val context = LocalContext.current
    val schoolContext = LocalSchoolContext.current
    val viewModel: TextInputViewModel = viewModel(factory = TextInputViewModelFactory(schoolContext.schoolRepository))
